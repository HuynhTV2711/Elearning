          ...
          <div className="row">
            <div className="col-lg-4 col-sm-12 col-12 mb-4">
              ...
              <div className="thong_tin">
                <div>
                  <p>
                    Tài khoản: <span>{thongTinCaNhan.taiKhoan}</span>
                  </p>
                </div>
                <hr />
                <div>
                  <p>
                    Email: <span>{thongTinCaNhan.email}</span>
                  </p>
                </div>
                <hr />
                <div>
                  <p>
                    Họ và tên: <span>{thongTinCaNhan.hoTen}</span>
                  </p>
                </div>
                <hr />
                <div>
                  <p>
                    Số điện thoại: <span>{thongTinCaNhan.soDT}</span>
                  </p>
                </div>
                <hr />
                <div>
                  <p>
                    Mã lọai người dùng:{" "}
                    <span>{thongTinCaNhan.maLoaiNguoiDung}</span>
                  </p>
                </div>
                <hr />
                <div>
                  <p>
                    Mã nhóm: <span>{thongTinCaNhan.maNhom}</span>
                  </p>
                </div>
              </div>
              <div>
                    ...
                    <div className="thong_tin_khoa_hoc">
                      ...
                      <div className="kh_footer">
                        <div className="giang_vien">
                          <img
                            src="https://images.unsplash.com/photo-1540569014015-19a7be504e3a?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                            alt=""
                          />
                          <p>Tên giảng viên</p>
                        </div>
                        <div>
                          <button
                            onClick={() => {
                              huyGhiDanh(valueHuy(item.maKhoaHoc));
                            }}
                          >
                            Hủy khóa học
                          </button>
