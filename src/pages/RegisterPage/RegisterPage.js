...
const RegisterPage = () => {
  ...
  const { handleSubmit, handleChange, handleBlur, values, errors, touched } =
    useFormik({
      ...
      onSubmit: (values) => {
        console.log(values);
        quanLiNguoiDungServ.register(values)
        .then((result) => {
          console.log(result);
          messageApi.open({
            type: 'success',
        ...
        <div className="col-12 col-md-12 col-lg-6">
          <form onSubmit={handleSubmit}>
            ...
            <div class="mb-2">
              ...
              <select class="form-select form-select-lg py-1" name="maNhom" id="maNhom"
              onChange={handleChange}
              onBlur={handleBlur}
              value={values.maNhom}>
            ...
            <button type="submit" className="register_btn">Đăng ký</button>
          </form>
        </div>
